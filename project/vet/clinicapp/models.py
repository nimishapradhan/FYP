...
departments = [('Senior Veterinarian', 'Senior Veterinarian'),
               ('Assistant Veterinarian', 'Assistant Veterinarian'),
               ]
...
class Doctor(models.Model):
    ...
    department = models.CharField(
        max_length=50, choices=departments, default='Senior Veterinarian')
...
class Gallery(models.Model):
    categories = [('Vaccination', 'Vaccination'),
                ('Preventive care', 'Preventive care'),

                ('OPD', 'OPD'),
                ('Senior age care', 'Senior age care'),
                ]
    category=models.CharField(choices=categories,max_length=50,default='Senior Veterinarian')
