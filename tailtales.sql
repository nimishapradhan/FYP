...
-- Dumping data for table myprojectdb.auth_permission: ~24 rows (approximately)
...
-- Dumping data for table myprojectdb.auth_user: ~0 rows (approximately)
...
-- Dumping data for table myprojectdb.django_content_type: ~6 rows (approximately)
...
-- Dumping data for table myprojectdb.django_session: ~0 rows (approximately)
...
-- Dumping data for table myprojectdb.pet_owner: ~2 rows (approximately)
INSERT INTO `pet_owner` (`id`, `first_name`, `last_name`, `email`, `phone_number`, `gender`, `password`, `address`) VALUES
	(1, 'Manoj', 'Karki', 'manojgamer99@gmail.com', '+977 1234567890', 'male', '1234apple', 'kalanki'),
	(2, 'Lujana', 'Bajracharya', 'luj@gmail.com', '+977 1234567890', 'female', '1234apple', 'ason');
